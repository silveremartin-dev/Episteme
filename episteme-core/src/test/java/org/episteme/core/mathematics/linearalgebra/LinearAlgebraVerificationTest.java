...
public class LinearAlgebraVerificationTest {
    ...
    public void testRealDoubleMatrixCreation() {
        ...
        Matrix<Real> m = Matrix.of(realData, org.episteme.core.mathematics.sets.Reals.getInstance());
    ...
    public void verifyOperationsAgainstEJML() {
        ...
        Vector<Real> v = org.episteme.core.mathematics.linearalgebra.vectors.RealDoubleVector.of(vData);
