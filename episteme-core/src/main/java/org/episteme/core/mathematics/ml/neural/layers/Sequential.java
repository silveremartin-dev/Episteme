...
public class Sequential<T> implements Layer<T> {
    ...
    @Override
    public java.util.Map<String, org.episteme.core.mathematics.ml.neural.autograd.GraphNode<T>> getParameters() {
        java.util.Map<String, org.episteme.core.mathematics.ml.neural.autograd.GraphNode<T>> params = new java.util.HashMap<>();
        for (int i = 0; i < layers.size(); i++) {
            Layer<T> layer = layers.get(i);
            java.util.Map<String, org.episteme.core.mathematics.ml.neural.autograd.GraphNode<T>> layerParams = layer.getParameters();
