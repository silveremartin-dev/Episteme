...
import org.episteme.computing.graph.algorithms.util.VertexDegreeComparator;
import org.episteme.computing.graph.graphs.Subgraph;
import org.episteme.computing.graph.graphs.UndirectedSubgraph;
...
public class VertexCovers {
     ...
     * org.episteme.computing.graph.GraphHelper#undirectedGraph(Graph)} or {@link
     * org.episteme.computing.graph.graph.AsUndirectedGraph}.
     * </p>
     *
     * @param g the graph for which vertex cover approximation is to be found.
     * @return a set of vertices which is a vertex cover for the specified
