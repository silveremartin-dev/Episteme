package org.episteme.computing.ai.evolutionary.geneticalgorithms;
...
public abstract class BinaryCodedGA {
    ...
    public double evaluateIndividual(int chromosomeNo, boolean[] chromosome) {
        ...
        throw new InvalidGAConfigurationException("evaluateIndividual(int chromosomeNo, boolean[] chromosome) method in org.episteme.computing.ai.BinaryCodedGA should be overridden.");
    }
