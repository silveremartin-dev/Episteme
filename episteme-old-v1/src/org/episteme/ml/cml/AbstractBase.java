...
public interface AbstractBase extends Element, CMLNode {
    ...
    public final static String PACKAGE_NAME = "org.episteme.ml.cml";
...
// ------------------ content model stuff ----------------
     ...
     * @param attVal
     */
    void /*setUntypedAttribute*/setAttribute(String attName, String attVal)/* throws org.episteme.ml.cml.CMLException*/;
     ...
     * @param attName
     */
    String /*getUntypedAttribute*/getAttribute(String attName)/* throws org.episteme.ml.cml.CMLException*/;
     ...
     */
    void removeTextChildren() throws org.episteme.ml.cml.CMLException;
     ...
     */
    Element getOrCreateChild(String elemName) throws org.episteme.ml.cml.CMLException;
    ...
    void characters(SaxHandler saxHandler, String content) throws org.episteme.ml.cml.CMLException;
     ...
     */
    void endElement(SaxHandler saxHandler) throws org.episteme.ml.cml.CMLException;
     ...
     *                   throws exception (probably application specific)
     */
    void startElement(SaxHandler saxHandler, Attributes attributes) throws org.episteme.ml.cml.CMLException;
     ...
     * @param w - output
     */
    void writeXML(Writer w) throws org.episteme.ml.cml.CMLException, IOException;
