package org.episteme.ml.cml.cmlimpl;

import org.episteme.ml.cml.*;
import org.episteme.ml.cml.dom.pmr.PMRDocument;
import org.episteme.ml.cml.dom.pmr.PMRElementImpl;
import org.episteme.ml.cml.util.CMLUtils;
import org.episteme.ml.cml.util.PMRDOMUtils;
import org.w3c.dom.*;
...
public class CMLBaseImpl extends PMRElementImpl implements AbstractBase {
    ...
    static Logger logger = Logger.getLogger("org.episteme.ml.cml.cmlimpl.CMLBaseImpl");
...
// =================================================
     ...
     * @throws org.episteme.ml.cml.CMLException
     *          element cannot be added (violates content model)
     */
    public void addChild(Element elem) throws org.episteme.ml.cml.CMLException {
     ...
     *          element cannot be added (violates content model)
     */
    public Node appendChild(Element elem) throws org.episteme.ml.cml.CMLException {
     ...
     *          element cannot be added (violates content model)
     */
    public Element getOrCreateChild(String elemName) throws org.episteme.ml.cml.CMLException {
     ...
     */
    public void characters(SaxHandler saxHandler, String content) throws org.episteme.ml.cml.CMLException {
     ...
     */
    public void endElement(SaxHandler saxHandler) throws org.episteme.ml.cml.CMLException {
...
//        ((SaxHandlerImpl)saxHandler).backtrackParent();
     ...
     *                   throws exception (probably application specific)
     */
    public void startElement(SaxHandler saxHandler, Attributes attributes) throws org.episteme.ml.cml.CMLException {
        if (tool != null && !(tool instanceof BaseToolImpl)) {
...
//               System.out.println("Name: "+name+"/value: "+value);
     ...
     *
     */
    public void writeXML(Writer w, String control) throws org.episteme.ml.cml.CMLException, IOException {
     ...
     * @param w - output
     */
    public void writeXML(Writer w) throws org.episteme.ml.cml.CMLException, IOException {
        String control = version;
        if (arraySyntax) control += " array";
        writeXML(w, control);
    }

    public static void writeXML0(Element elem, Writer w, String control) throws IOException, org.episteme.ml.cml.CMLException {
    ...
    public static void outputChildren(Element elem, Writer w, String control)
            throws IOException, org.episteme.ml.cml.CMLException {
    ...
    public BaseTool getOrCreateTool() {
        if (tool == null) {
            ...
            if (classx.endsWith("Impl")) {
                ...
                if (classx.indexOf("org.episteme.ml.cml.cmlimpl.") == 0) {
                    classx = classx.substring("org.episteme.ml.cml.cmlimpl.".length());
