...
import org.episteme.ml.cml.AbstractBase;
import org.episteme.ml.cml.AbstractCMLDocument;
import org.episteme.ml.cml.CMLException;
import org.episteme.ml.cml.dom.pmr.PMRDocumentImpl;
...
//			System.out.println ("saving as CMLBaseImpl");
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            System.out.println("Usage: java org.episteme.ml.cml.cmlimpl.CMLDocumentImpl -IN url [-OUT file]");
            System.exit(0);
        }
