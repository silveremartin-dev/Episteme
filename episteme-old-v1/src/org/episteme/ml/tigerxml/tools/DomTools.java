...
package org.episteme.ml.tigerxml.tools;
...
public class DomTools {
    ...
    public static final Element getElement(Element ele, String name) {
        ...
        if (list_of_nodes.getLength() != 1) {
            System.err.println("org.episteme.ml.tigerxml.tools.DomTools: "
    ...
    public static final void checkElementName(Element ele, String name) {
        if (!((ele.getNodeName()).equals(name))) {
            System.err.println("org.episteme.ml.tigerxml.tools.DomTools: WARNING: Expected "
                    + name + " node");
        }
    } // check element name
    ...
    public static final String getText(Element ele) {
        ...
        if (list_of_nodes.getLength() >= 1) {
            ...
            if (type == Node.TEXT_NODE) {
                ...
                System.err.println("org.episteme.ml.tigerxml.tools.DomTools: WARNING: Expected text node");
            }
        }
