 ...
 * {@link org.episteme.mathematics.vector.Matrix matrices}, even if the
 ...
 * based upon the current {@link org.episteme.physics.model.PhysicalModel
 * PhysicalModel}. For example, adding <code>Amount&lt;Length&gt; and
 * <code>Amount&lt;Duration&gt; is not allowed by the
 * {@link org.episteme.physics.model.StandardModel StandardModel},
 * but is authorized with the {@link
 * org.episteme.physics.model.RelativisticModel RelativisticModel}.</p>
 *
