package org.episteme.sociology;

import org.episteme.linguistics.Language;

import org.episteme.philosophy.Belief;

import org.episteme.util.Commented;
import org.episteme.util.Named;
...
//we could also add typical artwork, or typical artifacts (org.episteme.economics.Resource, or org.episteme.economics.decorum.Artifact)
//we could list hobbies and sports
//we could also list existing culture specific organizations (institutions)
//we could also list events on a typical day (org.episteme.history.Timeline or org.episteme.philosophy.storytelling.Event)
...
/**
    ...
    //we could list hobbies and sports
    //we could also list existing culture specific organizations (institutions)
    //we could also list events on a typical day (org.episteme.history.Timeline or org.episteme.philosophy.Events.Event)
    //we could also list some typical roles, situations
}
