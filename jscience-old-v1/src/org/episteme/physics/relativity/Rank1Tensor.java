package org.episteme.physics.relativity;
...
/**
    ...
    public boolean equals(Object a) {
        if (a instanceof Rank1Tensor) {
            ...
            return (Math.abs(rank1[0] - v.rank1[0]) <= Double.valueOf(Episteme.getProperty(
                    "tolerance")).doubleValue()) &&
            (Math.abs(rank1[1] - v.rank1[1]) <= Double.valueOf(Episteme.getProperty(
                    "tolerance")).doubleValue()) &&
            (Math.abs(rank1[2] - v.rank1[2]) <= Double.valueOf(Episteme.getProperty(
                    "tolerance")).doubleValue()) &&
            (Math.abs(rank1[3] - v.rank1[3]) <= Double.valueOf(Episteme.getProperty(
                    "tolerance")).doubleValue());
        }
