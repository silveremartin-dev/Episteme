 ...
 *
 */
package org.episteme.computing.graph.external;

import org.jgraph.event.GraphModelEvent;
import org.jgraph.event.GraphModelEvent.GraphModelChange;
import org.jgraph.event.GraphModelListener;
import org.jgraph.graph.*;
import org.episteme.computing.graph.DirectedGraph;
import org.episteme.computing.graph.EdgeFactory;
import org.episteme.computing.graph.Graph;
import org.episteme.computing.graph.ListenableGraph;
import org.episteme.computing.graph.events.GraphEdgeChangeEvent;
import org.episteme.computing.graph.events.GraphListener;
import org.episteme.computing.graph.events.GraphVertexChangeEvent;
 ...
 * org.episteme.computing.graph.ListenableGraph}. If the underlying JGraphT graph is
...
public class JGraphModelAdapter extends DefaultGraphModel {
    ...
    public JGraphModelAdapter(Graph jGraphTGraph,
        ...
        for (Iterator i = jGraphTGraph.edgeSet().iterator(); i.hasNext();) {
            handleJGraphTAddedEdge((org.episteme.computing.graph.Edge) i.next());
        }
     ...
     */
    public DefaultEdge getEdgeCell(org.episteme.computing.graph.Edge jGraphTEdge) {
    ...
    void handleJGraphChangedEdge(org.jgraph.graph.Edge jEdge) {
        if (isDangling(jEdge)) {
            ...
            if (m_cellToEdge.containsKey(jEdge)) {
                ...
                org.episteme.computing.graph.Edge jtEdge =
                        (org.episteme.computing.graph.Edge) m_cellToEdge.get(jEdge);
     ...
     */
    void handleJGraphTAddedEdge(org.episteme.computing.graph.Edge jtEdge) {
     ...
     *               graph model.
     */
    void handleJGraphTRemovedEdge(org.episteme.computing.graph.Edge jtEdge) {
    ...
    public static interface CellFactory {
         ...
         */
        public DefaultEdge createEdgeCell(org.episteme.computing.graph.Edge jGraphTEdge);
    ...
    public static class DefaultCellFactory implements CellFactory, Serializable {
        ...
        /**
         * @see org.episteme.computing.graph.external.JGraphModelAdapter.CellFactory#createEdgeCell(org.episteme.computing.graph.Edge)
         */
        public DefaultEdge createEdgeCell(org.episteme.computing.graph.Edge jGraphTEdge) {
        ...
        /**
         * @see org.episteme.computing.graph.external.JGraphModelAdapter.CellFactory#createVertexCell(Object)
         */
        public DefaultGraphCell createVertexCell(Object jGraphTVertex) {
    ...
    private class JGraphTListener implements GraphListener, Serializable {
        ...
        public void edgeAdded(GraphEdgeChangeEvent e) {
            org.episteme.computing.graph.Edge jtEdge = e.getEdge();
        ...
        /**
         * @see org.episteme.computing.graph.events.VertexSetListener#vertexAdded(GraphVertexChangeEvent)
         */
        ...
        /**
         * @see org.episteme.computing.graph.events.VertexSetListener#vertexRemoved(GraphVertexChangeEvent)
         */
    ...
    private class ShieldedGraph {
        ...
        boolean addEdge(org.episteme.computing.graph.Edge jtEdge) {
        ...
        void removeEdge(org.episteme.computing.graph.Edge jtEdge) {
