...
package org.episteme.astronomy.solarsystem;

import org.episteme.astronomy.ArtificialSatellite;
import org.episteme.astronomy.MiscellaneousUtils;
import org.episteme.astronomy.solarsystem.SDP4;
import org.episteme.astronomy.solarsystem.sputnik.SDP4;
 ...
 * {@link org.episteme.astronomy.solarsystem.SDP4 SDP4} so that it can calculate ephemeris of an
 ...
 *         &lt; hme &#64; roe.ac.uk &gt;
 * @see Telescope
 * @see org.episteme.astronomy.solarsystem.sputnik.SDP4
 * @see org.episteme.astronomy.solarsystem.sputnik
 */
 ...
 * exception we catch and ignore it, but break the loop. */
   ...
   * Also extract/transform the velocity. */
     ...
     * {@link org.episteme.astronomy.solarsystem.sputnik.SDP4#NoradNext SDP4.NoradNext} and
     * {@link org.episteme.astronomy.solarsystem.sputnik.SDP4#ReadNorad12 SDP4.ReadNorad12}.
     *
