...
public class TBuilder {
    ...
    public static final void buildT(T t, Sentence sent, Element tElement, int pos) {
        ...
        if (t.getVerbosity() >= 4) {
            System.err.println("org.episteme.ml.tigerxml.core.TBuilder: Building and adding T "
        ...
        if (tElement.hasAttribute("id")) {
            ...
            if (t.getVerbosity() > 0) {
                System.err.println("org.episteme.ml.tigerxml.T: WARNING: Terminal element " +
        ...
        if (tElement.hasAttribute("word")) {
            ...
            if (t.getVerbosity() > 0) {
                System.err.println
                        ("org.episteme.ml.tigerxml.T: WARNING: Terminal element " +
