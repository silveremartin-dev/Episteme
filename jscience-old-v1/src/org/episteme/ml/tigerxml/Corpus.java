...
package org.episteme.ml.tigerxml;

import org.episteme.ml.tigerxml.core.CorpusBuilder;
import org.episteme.ml.tigerxml.core.TigerXmlDocument;
...
public class Corpus
     ...
     * useful for parsing a corpus file by hand instead of letting the org.episteme.ml.tigerxml
     * build it.
     * <p/>
     ...
     *
     * @return An integer denoting the number of sentences in this corpus.
     * @deprecated As of org.episteme.ml.tigerxml 1.1 - use {@link #getSentenceCount()} instead.
     */
     ...
     *         closest.
     * @see org.episteme.ml.tigerxml.tools.GeneralTools#minEditDistance(ArrayListlistA,ArrayListlistB)
     */
...
//  }
     ...
     * {@link org.episteme.ml.tigerxml.tools.GeneralTools#sortNodes(ArrayListnodes)}.
     *
     ...
     * org.episteme.ml.tigerxml.tools.GeneralTools#sortTerminals(ArrayListunsortedTerminals)}.
     *
    ...
    public void print2Xml(String xmlFileName, int from, int to) {
        if ((this.getSentenceCount() <= to) || (from > to)) {
            if (this.verbosity > 0) {
                System.err.println("org.episteme.ml.tigerxml.Corpus#print2Xml: Cannot write sentences "
                        + from + " to " + to + " (Corpus only contains "
                        + this.getSentenceCount() + " sentences).");
            }
        }
        if (this.verbosity > 0) {
            System.err.println("org.episteme.ml.tigerxml.Corpus: Writing XML file " + xmlFileName +
                    " ...");
        }
        try {
