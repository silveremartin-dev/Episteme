 ...
 */
package org.episteme.ml.tigerxml.theories.hobbs78;

import org.episteme.ml.tigerxml.GraphNode;
import org.episteme.ml.tigerxml.NT;
import org.episteme.ml.tigerxml.T;
import org.episteme.ml.tigerxml.tools.GeneralTools;
import org.episteme.ml.tigerxml.tools.IndexFeatures;
import org.episteme.ml.tigerxml.tools.SyncMMAX;
import org.episteme.ml.tigerxml.tools.SyntaxTools;
...
/**
    ...
    private static boolean npOrSLikeBetween(GraphNode lower, NT higher) {
        ...
        while (cont) {
            if (mother == null) {
                System.err.println(
                    "org.episteme.ml.tigerxml.theories.hobbs78.BreadthFirstSearcher: " +
                ...
                cont = false;
            } else if (org.episteme.ml.tigerxml.tools.SyntaxTools.isNpLikeNode(
                        mother) ||
                    org.episteme.ml.tigerxml.tools.SyntaxTools.isSLikeNode(
                        mother)) {
                cont = false;
                return_value = true;
            }
