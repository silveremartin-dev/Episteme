...
import org.episteme.ml.cml.logger.JumboLogger;
...
// get the object each time as it may be contaminated by previous runs
     ...
     * e.g. converts org.episteme.ml.cml.CMLVector3 to org.episteme.ml.cml.cmlimpl.Vector3Impl
    ...
    public static String convertInterfaceToClass(String interfaceName) {
        ...
        if (interfaceName.startsWith("org.episteme.ml.cml.")) {
            className = interfaceName.substring("org.episteme.ml.cml.".length());
        }
        ...
        if (interfaceName.startsWith("org.episteme.ml.cml.")) {
            className = "org.episteme.ml.cml.cmlimpl." + className;
        }
        return className;
    }
     ...
     * e.g. converts org.episteme.ml.cml.cmlimpl.Vector3Impl to org.episteme.ml.cml.CMLVector3
    ...
    public static String convertClassToInterface(String className) {
        ...
        if (className.startsWith("org.episteme.ml.cml.cmlimpl.")) {
            interfaceName = interfaceName.substring("org.episteme.ml.cml.cmlimpl.".length());
        }
        ...
        if (className.startsWith("org.episteme.ml.cml.cmlimpl.")) {
            interfaceName = "org.episteme.ml.cml." + interfaceName;
        }
