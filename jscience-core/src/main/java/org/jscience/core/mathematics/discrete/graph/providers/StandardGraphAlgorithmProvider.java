...
package org.jscience.core.mathematics.discrete.graph.providers;
...
public class StandardGraphAlgorithmProvider implements GraphAlgorithmProvider {
    ...
    public String getName() {
        return "Standard Graph Algorithm Provider (Louvain)";
    }
