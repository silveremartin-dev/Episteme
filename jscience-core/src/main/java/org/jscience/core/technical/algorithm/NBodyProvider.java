...
public interface NBodyProvider extends AlgorithmProvider {
    ...
    /**
     * Performs a single integration step using Velocity Verlet algorithm.
     */
    ...
    /**
     * Performs a single integration step using Velocity Verlet algorithm with Real objects.
     */
