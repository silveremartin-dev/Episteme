 ...
 */
public class CPUSparseLinearAlgebraBackend<E> extends CPUDenseLinearAlgebraBackend<E> implements SparseLinearAlgebraBackend<E> {

    public CPUSparseLinearAlgebraBackend(Ring<E> ring) {
        super(ring);
    }
