...
import org.episteme.core.distributed.DistributedExecutionContext;
...
public interface DistributedBackend extends ComputeBackend, DistributedComputingProvider {
     ...
     * (via {@link org.episteme.core.technical.backend.Backend}) and
     * {@link DistributedComputingProvider}
     * (via {@link org.episteme.core.technical.algorithm.AlgorithmProvider}),
     ...
     * and {@link org.episteme.core.technical.algorithm.AlgorithmProvider#isAvailable()}.
     */
    @Override
    boolean isAvailable();
