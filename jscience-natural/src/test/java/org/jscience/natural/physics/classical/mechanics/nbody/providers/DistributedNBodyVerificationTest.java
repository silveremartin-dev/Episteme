package org.jscience.natural.physics.classical.mechanics.nbody.providers;
...
public class DistributedNBodyVerificationTest {
    ...
    private org.jscience.natural.physics.classical.mechanics.nbody.providers.DistributedNBodyProvider provider;

    @BeforeEach
    void setUp() {
        provider = new org.jscience.natural.physics.classical.mechanics.nbody.providers.DistributedNBodyProvider();
