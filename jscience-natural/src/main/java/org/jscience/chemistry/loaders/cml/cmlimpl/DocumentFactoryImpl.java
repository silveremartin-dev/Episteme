...
import org.jscience.chemistry.loaders.cml.AbstractCMLDocument;
import org.jscience.chemistry.loaders.cml.CMLDocumentFactory;
import org.jscience.chemistry.loaders.cml.CMLException;
...
/**
    ...
    public AbstractCMLDocument parseSAX(InputSource is, boolean debug)
        ...
        try {
            ...
            e.printStackTrace();
            throw new org.jscience.chemistry.loaders.cml.CMLException("" + e);
        }
     ...
     */
    public Element parseSAX(InputSource is, AbstractCMLDocument doc,
        boolean debug) throws org.jscience.chemistry.loaders.cml.CMLException, IOException {
        SAXParser parser = null;
    ...
    /*
         ...
         *@return                                  Description of the Return Value
         *@exception  org.jscience.chemistry.loaders.cml.CMLException  Description of the Exception
         *@exception  IOException                  Description of the Exception
         *
        public Element parseSAX(InputSource is, AbstractCMLDocument doc, boolean debug, boolean ignoreWhite) throws org.jscience.chemistry.loaders.cml.CMLException, IOException {
            SAXParser parser = null;
            try {
                SAXParserFactory spf = SAXParserFactory.newInstance();
                // this seems to be essential if we use SAX2 startElement
