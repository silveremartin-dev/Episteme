...
public class BraKet {
    ...
    public BraKet(Complex... amplitudes) {
        this(org.episteme.core.mathematics.linearalgebra.Vector.of(Arrays.asList(amplitudes), org.episteme.core.mathematics.sets.Complexes.getInstance()), false);
    }
    ...
    public BraKet dual() {
        ...
        return new BraKet(org.episteme.core.mathematics.linearalgebra.Vector.of(Arrays.asList(dualData), org.episteme.core.mathematics.sets.Complexes.getInstance()), !isDual);
    }
    ...
    public BraKet tensor(BraKet other) {
        ...
        return new BraKet(org.episteme.core.mathematics.linearalgebra.Vector.of(Arrays.asList(result), org.episteme.core.mathematics.sets.Complexes.getInstance()), this.isDual);
    }
