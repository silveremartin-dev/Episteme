...
import org.jscience.mathematics.numbers.real.RealDoubleArray;
import org.jscience.technical.backend.math.FFTBackend;
import org.jscience.mathematics.analysis.transform.PanamaFFTBackend;
...
public class NativeFFTProvider implements FFTProvider {
    ...
    private Real[] toRealArray(double[] arr) {
        ...
        for (int i = 0; i < arr.length; i++) res[i] = RealDouble.create(arr[i]);
        return res;
    }
}
