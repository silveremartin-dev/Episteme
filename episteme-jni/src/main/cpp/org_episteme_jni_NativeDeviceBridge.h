...
#include <jni.h>
/* Header for class org_episteme_jni_NativeDeviceBridge */

#ifndef _Included_org_episteme_jni_NativeDeviceBridge
#define _Included_org_episteme_jni_NativeDeviceBridge
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_episteme_jni_NativeDeviceBridge
