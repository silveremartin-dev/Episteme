...
public class AudioAnalysisExample {
    ...
    public static void main(String[] args) {
        System.out.println("==========================================");
        System.out.println("   JScience Audio Analysis Example");
        System.out.println("==========================================");
        ...
        try {
            ...
            Class<?> clazz = Class.forName("org.jscience.core.media.backends.TarsosBackend");
            ...
            System.err.println("TarsosBackend class not found. Check jscience-core dependencies.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
